...
class PointingArrowLabel extends import_editor.StateNode {
  ...
  onPointerMove() {
    ...
    const geometry = (0, import_arrowLabel.getArrowBodyGeometry)(this.editor, shape);
    ...
    const defaultLabelPosition = (0, import_arrowLabel.getArrowLabelDefaultPosition)(this.editor, shape);
