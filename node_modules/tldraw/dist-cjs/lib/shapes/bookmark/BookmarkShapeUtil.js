...
__export(BookmarkShapeUtil_exports, {
  BookmarkIndicatorComponent: () => BookmarkIndicatorComponent,
  BookmarkShapeComponent: () => BookmarkShapeComponent,
...
var import_bookmarks = require("./bookmarks");
class BookmarkShapeUtil extends import_editor.BaseBoxShapeUtil {
  ...
  getAriaDescriptor(shape) {
    ...
    return (0, import_text.convertCommonTitleHTMLEntities)(asset.props.title) + (asset.props.description ? ", " + asset.props.description : "");
  }
  getDefaultProps() {
    return {
      url: "",
      w: import_bookmarks.BOOKMARK_WIDTH,
      h: import_bookmarks.BOOKMARK_HEIGHT,
      assetId: null
    };
  }
  component(shape) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookmarkShapeComponent, { assetId, url, h, rotation });
  }
  indicator(shape) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookmarkIndicatorComponent, { w: shape.props.w, h: shape.props.h });
  }
  onBeforeCreate(next) {
    return (0, import_bookmarks.setBookmarkHeight)(this.editor, next);
  }
  onBeforeUpdate(prev, shape) {
    if (prev.props.url !== shape.props.url) {
      if (!import_editor.T.linkUrl.isValid(shape.props.url)) {
        ...
        (0, import_bookmarks.updateBookmarkAssetOnUrlChange)(this.editor, shape);
      }
    }
    if (prev.props.assetId !== shape.props.assetId) {
      return (0, import_bookmarks.setBookmarkHeight)(this.editor, shape);
    }
  }
...
function BookmarkIndicatorComponent({ w, h }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: (0, import_editor.toDomPrecision)(w), height: (0, import_editor.toDomPrecision)(h), rx: "6", ry: "6" });
}
function BookmarkShapeComponent({
  ...
  const address = (0, import_bookmarks.getHumanReadableAddress)(url);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_editor.HTMLContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      style: {
        boxShadow: isSafariExport ? void 0 : (0, import_rotated_box_shadow.getRotatedBoxShadow)(rotation),
        maxHeight: h
      },
      children: [
        showImageContainer && (!asset || asset.props.image) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tl-bookmark__image_container", children: [
          ...
          asset?.props.image && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_HyperlinkButton.HyperlinkButton, { url })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tl-bookmark__copy_container", children: [
          asset?.props.title ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "a",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "tl-bookmark__heading", children: (0, import_text.convertCommonTitleHTMLEntities)(asset.props.title) })
            }
          ) : null,
